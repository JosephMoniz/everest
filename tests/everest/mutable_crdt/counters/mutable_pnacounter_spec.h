...
#include <everest/mutable_crdt/counters/mutable_pnacounter.h>
#include <sys/socket.h>
#include <everest/io/tcp_client_socket.h>

namespace everest {

void MutablePNACounterSpecification() {
  Describe("A MutablePNACounter type", []() {
    Describe("with an instance A of value 9 and an instance B of value -3", []() {
      auto aCounter = MutablePNACounter<int, int>(1, 9);
      auto bCounter = MutablePNACounter<int, int>(2, -3);
      Describe("and we render A with show", [&]() {
        It("should correctly render as 9", [&]() {
          AssertEquals(String("MutablePNACounter(9)"), aCounter.Show());
        });
      });
      Describe("and we render B with show", [&]() {
        It("should correctly render as -3", [&]() {
          AssertEquals(String("MutablePNACounter(-3)"), bCounter.Show());
        });
      });
      ...
      Describe("and we pass A and an equivalent value to Equals()", [&]() {
        It("should return true", [&]() {
          AssertTrue(aCounter.Equals(MutablePNACounter<int, int>(3, -3).IncrementBy(12)));
        });
      });
      Describe("and we pass B and an equivalent value to Equals()", [&]() {
        It("should return true", [&]() {
          AssertTrue(bCounter.Equals(MutablePNACounter<int, int>(3, 6).DecrementBy(9)));
        });
      });
      ...
      Describe("and we call Show() on A", [&]() {
        It("should render the correct string", [&]() {
          AssertEquals(String("MutablePNACounter(0)"), aCounter.Show());
        });
      });
    });
  });
